    ...
    <Link href={href} style={{ textDecoration: "none", display: "block" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <img src={logo_url} alt={title} style={{ width: 52, height: 52, borderRadius: "0.875rem", objectFit: "cover", border: "1px solid rgba(255,255,255,0.08)" }} />
          <div>
            <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: "1rem", letterSpacing: "-0.02em" }}>{title}</h3>
        ...
        <p style={{ fontSize: "0.8125rem", color: "rgba(248,250,252,0.4)", lineHeight: 1.6, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
          {description}
        </p>
