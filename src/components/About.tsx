...
const features = [
  {
    ...
    description: "Built on the Falix Engine for uncompromising speed and efficiency."
  },
  {
    icon: Shield,
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-white/40 font-medium max-w-xl leading-relaxed">
              At Falix, we don't just build software; we craft experiences. Our mission is to bridge the gap between platforms, 
          ...
          >
            <div className="glass-card aspect-square rounded-[4rem] p-4 relative overflow-hidden group">
               ...
               <div className="w-full h-full rounded-[3rem] bg-white/5 border border-white/10 flex items-center justify-center relative overflow-hidden">
                  <span className="text-8xl font-black text-white/5 select-none">FALIX</span>
                  <motion.div 
                    animate={{ rotate: 360 }}
