    ...
    <main className="flex min-h-screen flex-col items-center bg-[#030303] text-white">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
             <div className="glass-card p-8 space-y-4">
                ...
                <p className="text-xs text-white/40 leading-relaxed font-medium">All binaries are signed with Falix's official certificate and scanned for vulnerabilities.</p>
             </div>
             <div className="glass-card p-8 space-y-4">
             ...
             <div className="glass-card p-8 space-y-4">
                ...
                <p className="text-xs text-white/40 leading-relaxed font-medium">Need help? Join our community or contact support at help@falix.in.</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <footer className="w-full py-20 px-6 border-t border-white/5 mt-auto">
        <div className="container mx-auto flex justify-between items-center opacity-40">
            <span className="font-black tracking-tighter text-2xl">FALIX</span>
            <p className="text-xs font-bold uppercase tracking-widest">© 2026 FALIX PLATFORM.</p>
        </div>
      </footer>
    </main>
  );
