    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#030303] text-white">
        <div className="text-center space-y-4">
          ...
          <Link href="https://falix.in" className="text-blue-500 hover:underline">Back to Falix</Link>
        </div>
      </div>
    );
  }
    ...
    <main className="flex min-h-screen flex-col items-center">
                ...
                {(appData.features && appData.features.length > 0) ? (
                    ...
                    <>
                        <div className="glass-card lg:col-span-2 p-16 flex flex-col justify-end min-h-[500px]">
                            ...
                            <p className="text-white/40 text-xl font-bold uppercase tracking-tight">Optimized for every architecture. Get the best out of your hardware with Falix's high-speed engine.</p>
                        </div>
      ...
      <footer className="w-full py-24 px-6 border-t border-white/5 mt-auto">
        <div className="max-content flex flex-col md:flex-row justify-between items-center gap-12 opacity-20">
            <span className="font-black tracking-tighter text-4xl">FALIX</span>
            <p className="text-xs font-black uppercase tracking-[0.3em]">© 2026 {appData.title.toUpperCase()}. POWERED BY FALIX ENGINE.</p>
        </div>
      </footer>
    </main>
  );
