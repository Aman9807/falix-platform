...
export const metadata: Metadata = {
  title: "About | Flynx Platform",
  description: "Learn about the mission, values, and team behind Flynx.",
};

const MILESTONES = [
  { year: "2022", title: "Founded",          desc: "Flynx was born from a need for modern sports management tools that don't look like they're from 2009." },
  { year: "2023", title: "First App Ships",  desc: "SchoolOS — our flagship sports academy management app — launched to 50 pilot academies." },
  { year: "2024", title: "Platform Launch",  desc: "Flynx Platform 1.0 launched. Subdomain routing, multi-tenant architecture, and admin dashboards." },
      ...
      <div className="container-xl">
        ...
        <div style={{ textAlign: "center", marginBottom: "5rem", maxWidth: "60ch", margin: "0 auto 5rem" }}>
          ...
          <p style={{ fontSize: "1.0625rem", color: "rgba(248,250,252,0.5)", lineHeight: 1.7 }}>
            Flynx started as a side project to fix the broken tools sports organizations were forced to use.
        ...
        <div style={{
          ...
          <p style={{ fontSize: "0.9375rem", color: "rgba(248,250,252,0.45)", marginBottom: "1.75rem", maxWidth: "40ch", margin: "0 auto 1.75rem" }}>
            We're just getting started. The best version of Flynx is the one we build together with our community.
          </p>
